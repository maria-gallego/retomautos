  ...
  def index
    @blog_posts = [
      ...
      BlogPost.new(
          ...
          card_text: 'BMW cuenta con una línea especial de vehícos deportivos, los cuales hacen parte de la división BMW Motorsport, y utilizan la letra M para diferenciarse del resto de vehículos de la marca.',
          card_link: '',
          blog_image: 'fotos_tu_carro/bmw_420gc.jpg'
      ),
    ]
