module Sales
  class BuyProcessesController < ApplicationController
    ...
    def show
      ...
      @next_buy_process = BuyProcess.next_active_process_with_same_salesperson(@buy_process)
      @previous_buy_process = BuyProcess.previous_active_process_with_same_salesperson(@buy_process)
